...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-auth-auth-module"], {
  ...
  function srcAppPagesAuthLoginPageLoginPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/toast.service.ts"); // import { ToastrService } from 'ngx-toastr';


    var LoginPageComponent =
    /*#__PURE__*/
    function () {
      function LoginPageComponent(authService, router, formBuider, toastr) {
      ...
      _createClass(LoginPageComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.authService.signIn(account).subscribe(function () {
            ...
            if (err.status === 401) {
              _this.invalidCredentials = 'Tài khoản hoặc mật khẩu không hợp lệ';
            } else {
              _this.invalidCredentials = 'Xãy ra lỗi';
            }
          });
        }
      }, {
