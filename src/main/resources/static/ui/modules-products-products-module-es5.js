...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-products-products-module"], {
  ...
  function srcAppModulesProductsDialogDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function DialogComponent(dialogRef, data, productSv, formBuilder, productLineService, fieldService, unitsService) {
    ...
    function () {
      ...
      _createClass(ProductsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productService.products$.subscribe(function (l) {
            _this5.products = l;
