...
const routes = [
    {
        path: 'auth',
        loadChildren: () => Promise.all(/*! import() | pages-auth-auth-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./pages/auth/auth.module */ "./src/app/pages/auth/auth.module.ts")).then(m => m.AuthModule)
    },
    {
        path: '',
        ...
        children: [
            {
                path: 'monthly-production',
                loadChildren: () => Promise.all(/*! import() | modules-monthly-production-monthly-production-module */[__webpack_require__.e("common"), __webpack_require__.e("modules-monthly-production-monthly-production-module")]).then(__webpack_require__.bind(null, /*! ./modules/monthly-production/monthly-production.module */ "./src/app/modules/monthly-production/monthly-production.module.ts")).then(m => m.MonthlyProductionModule)
            },
            {
                path: 'products',
                loadChildren: () => Promise.all(/*! import() | modules-products-products-module */[__webpack_require__.e("common"), __webpack_require__.e("modules-products-products-module")]).then(__webpack_require__.bind(null, /*! ./modules/products/products.module */ "./src/app/modules/products/products.module.ts")).then(m => m.ProductsModule)
            },
            {
                path: 'product-line',
                loadChildren: () => Promise.all(/*! import() | modules-product-line-product-line-module */[__webpack_require__.e("common"), __webpack_require__.e("modules-product-line-product-line-module")]).then(__webpack_require__.bind(null, /*! ./modules/product-line/product-line.module */ "./src/app/modules/product-line/product-line.module.ts")).then(m => m.ProductLineModule)
            },
            {
                path: 'units',
                loadChildren: () => Promise.all(/*! import() | modules-units-units-module */[__webpack_require__.e("common"), __webpack_require__.e("modules-units-units-module")]).then(__webpack_require__.bind(null, /*! ./modules/units/units.module */ "./src/app/modules/units/units.module.ts")).then(m => m.UnitsModule)
            },
            {
                path: 'type-data',
